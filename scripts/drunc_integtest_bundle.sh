...
integtest_list=( "process_manager_test.py", "test_failure_mode_death_on_boot_nest_app.py", "test_failure_mode_death_on_boot_top_app.py") #, "test_failure_mode_death_post_boot_nest_app.py") # FIGURE OUT WHY BOTH MEANS ONE FAILS, AND REPOIRT THE `jq` UTILITY ERROR
