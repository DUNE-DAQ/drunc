...
from drunc.tests.grpc.test_pb2_grpc import RootControllerServiceServicer
...
class RootControllerServiceImpl(RootControllerServiceServicer):
    ...
    def Kill(self, request: KillRequest, context) -> KillResponse:
        """
        Handle graceful shutdown requests for the RootController service.
        
        This method initiates a graceful shutdown of the RootController process
        ...
        print(f"RootController shutdown requested. Reason: {reason}")
        ...
        return KillResponse(
            ...
            message="RootController shutdown initiated",
