...
class InvalidTransition(FSMException):
    ...
    def __init__(self, transition: str, state: str) -> None:
...
class MissingArgument(FSMException):
    ...
    def __init__(self, param: str, name: str) -> None:
...
class InvalidActionMethod(FSMException):
    ...
    def __init__(self, iface: str, method: str) -> None:
...
class MethodSignatureMissingAnnotation(FSMException):
    def __init__(self, iface: str, method: str, pname: str) -> None:
...
class InvalidDataReturnByFSMAction(FSMException):
    def __init__(self, data: object) -> None:
        self.message = (
            f"The action returns an incorrect object which isn't serialisable: {data}"
        )
        super().__init__(self.message)
