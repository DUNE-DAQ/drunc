...
from drunc_messages.request_response_pb2 import Request, ResponseFlag
...
class DecodedResponse:
    ## Warning! This should be kept in sync with drunc_messages/request_response.proto/Response class
    name = None
    token = None
    data = None
    flag = None
