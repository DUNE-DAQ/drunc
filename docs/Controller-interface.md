...
### `Status`
This message encodes the status (and FSM status) of a controller or DAQ application. It has the [form](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/controller.proto#L84C1-L90C2):
```
message Status {
  string name = 1;
  string state = 2;
...
### `ChildrenStatus`
This message is a list of the above Status, and encodes the statuses of the children of the controller. [Schema](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/controller.proto#L92) is:
```
...
### `Argument`
This message is for describing a generic FSM argument. It has the [form](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/controller.proto#L46):
```
message Argument {
  enum Presence{
    MANDATORY = 0;
...
have the [form](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/controller.proto#L66):
```
...
### `FSMCommand`
Have the [format](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/controller.proto#L24):
```
message FSMCommand{
...
* `arguments` is a map of argument names to their values. Their value must be one of the 4:
  * [`int_msg`](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/generic.proto#L22)
  * [`float_msg`](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/generic.proto#L25)
  * [`string_msg`](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/generic.proto#L28)
  * [`bool_msg`](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/generic.proto#L31)
...
### `FSMCommandResponse`
The format is described in [here](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/controller.proto):
```
...
### `ls`
* input: None
* output: [PlainTextVector](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/generic.proto#L11) containing all a list of the controller's children
* interruption/exceptions:
  * None hopefully
...
* output: [PlainText](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/generic.proto#L7) of the form: "<controller_name> excluded"
* interruption/exceptions:
  * The sender is not in control of the controller
...
* output: [PlainText](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/generic.proto#L7) of the form: "<controller_name> included"
* interruption/exceptions:
  * The sender is not in control of the controller
...
* output: [PlainText](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/generic.proto#L7) of the form: "<user_name> took control"
* interruption/exceptions:
...
* output: [PlainText](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/generic.proto#L7) of the form: "<user_name> surrendered control"
* interruption/exceptions:
  * The sender is not in control of the controller
...
* input: None
* output: [PlainText](https://github.com/DUNE-DAQ/drunc-messages/blob/develop/schema/drunc-messages/generic.proto#L7) of the form: "<user_name>"
* interruption/exceptions:
  * None hopefully.
